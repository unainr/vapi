  ...
  >
      ...
      <div className="relative px-5 py-5 sm:px-6 sm:py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="inline-flex items-center rounded-full border border-gray-600/30 bg-black/75 px-3 py-1 text-xs font-medium text-white backdrop-blur-sm sm:text-sm">
              {subject}
            </span>
          </div>
          <div className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-600/30 bg-black/60 backdrop-blur-sm transition-transform duration-300 hover:rotate-12 sm:h-10 sm:w-10">
            <svg className="h-4.5 w-4.5 text-white sm:h-5 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="flex flex-grow flex-col px-5 pb-5 sm:px-6 sm:pb-6">
      <div className="mb-5 flex-grow sm:mb-6">
        <h3 className="mb-3 text-lg font-bold leading-tight text-gray-900 dark:text-white sm:text-xl">
          <PointerHighlight
          rectangleClassName="bg-blue-100 dark:bg-blue-900 border-blue-300 dark:border-blue-700 leading-loose"
            pointerClassName="text-blue-500 h-3 w-3"
            containerClassName="inline-block mx-1"
          >
            <span className="relative z-10 line-clamp-2">{name}</span>
          </PointerHighlight>
        </h3>
        <p className="line-clamp-3 min-h-[4.5rem] text-sm leading-relaxed text-gray-700 dark:text-gray-300 sm:text-base">
          {teaching_subject}
        </p>
      </div>
