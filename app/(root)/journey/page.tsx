...
const page = async () => {
	...
	return (
		<main className="min-h-screen bg-gray-50 px-4 py-8 lg:px-8 my-10">
	{/* Profile Header */}
					...
					<div className="flex flex-col lg:flex-row lg:items-center lg:gap-8">
						<div className="relative mb-6 lg:mb-0">
							<Image 
								...
								width={120} 
								height={120} 
								className="rounded-3xl ring-4 ring-white shadow-lg mx-auto lg:mx-0" 
							/>
						...
						<div className="text-center lg:text-left">
							...
							<p className="text-gray-600 text-lg mb-4 py-2 ">
							...
							<div className="flex flex-wrap gap-2 justify-center lg:justify-start">
								...
								<span className="px-4 py-2 bg-emerald-50 text-emerald-700 text-sm font-medium rounded-full">
									Active
								</span>
								<span className="px-4 py-2 bg-amber-50 text-amber-700 text-sm font-medium rounded-full">
									Top Learner
								</span>
							</div>
						</div>
	...
	<section className="max-w-6xl mx-auto mb-12">
		<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
			...
			<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
				<div className="flex items-center gap-4 mb-4">
					...
					<div>
						...
						<p className="text-gray-600 text-sm font-medium">Companions</p>
					</div>
				</div>
			...
			<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
				...
				<p className="text-gray-500 text-xs">+8 this week</p>
			</div>
			...
			<div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
				<div className="flex items-center gap-4 mb-4">
					...
					<div>
						<h3 className="text-3xl font-bold text-gray-900">127h</h3>
				...
				<p className="text-gray-500 text-xs">12h this week</p>
			</div>
		</div>
	</section>
	...
	<section className="max-w-6xl mx-auto">
		<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
			<div>
				<h2 className="text-3xl font-bold text-gray-900 mb-2">Your Companions</h2>
				<p className="text-gray-600">Your AI-powered learning partners</p>
			</div>
			<div className="flex items-center gap-4">
				...
				<button className="px-6 py-3 bg-gray-900 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors shadow-sm">
					+ Create New
				</button>
			</div>
		</div>
		...
		{companions.data && companions.data.length > 0 ? (
			...
			<div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
				...
				<h3 className="text-xl font-semibold text-gray-900 mb-2">Create Your First Companion</h3>
				<p className="text-gray-600 mb-8 max-w-md mx-auto">
					Get started by creating an AI learning companion tailored to your needs and interests.
				</p>
				<button className="px-8 py-4 bg-gray-900 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors shadow-sm">
					Create Companion
				</button>
			</div>
		)}
	...
	<div className="fixed bottom-6 right-6 z-50">
		<button className="w-14 h-14 bg-gray-900 text-white rounded-2xl shadow-lg hover:bg-gray-800 hover:scale-105 transition-all duration-200 flex items-center justify-center">
